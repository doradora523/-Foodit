  ...
  return (
    <div class="mt-[47px]">
      <div class="flex flex-col justify-center items-center">
        <div class="mb-[25px] text-[16px] font-medium">{MY_PAGE}</div>

        <div class="w-[105px] h-[105px] mb-[18px] rounded-full bg-mainColor"></div>
        ...
        <div class="w-[100%]">
          <div class="flex flex-col items-center mx-[16px] mb-[20px] pb-[9px] border-b-[0.5px] border-gray">
            ...
            <div class="text-gray text-[10px]">{'#ZNZLWM23'}</div>
          </div>
          <button class="float-right mt-[10px] absolute top-[225px] right-[4%]">
