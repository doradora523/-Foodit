...
function PostsPage() {
  ...
  return (
    <div class="relative">
      ...
      <div class="flex justify-center gap-[14px] w-[100%] top-[315px] absolute">
        <Carousel />
        <Carousel />
        <Carousel />
      </div>
      ...
      <div class="overflow-scroll h-[400px]">
        ...
        <div class="h-[115px] mx-[15px] border-b-[0.5px] border-gray"></div>
        ...
        <div class="w-[360px] h-[200px] p-[14px] mx-[15px] mb-[93px] rounded-[10px] bg-hexGray">
          <div class="w-[332px] h-[113px] p-[13px] rounded-[10px] bg-white font-medium text-[13px]">
            <div class="flex justify-between pb-[13px] border-b-[0.5px] border-gray">
              <div>{SUM}</div>
              <div>
                <div>{`${'20,000'}${WON}`}</div>
      ...
      <div class="flex justify-between w-[100%] h-[107px] px-[15px] pt-[18px] fixed bottom-0 border-t-[0.2px] border-gray bg-white">
        <div class="flex flex-col h-[50px]">
          ...
          <div class="font-semibold text-[16px] text-mainColor">{`${ACTUAL_PAYMENT_AMOUNT} ${'5,000'}${WON}`}</div>
        </div>
