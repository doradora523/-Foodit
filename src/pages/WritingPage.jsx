...
function WritingPage() {
  ...
  return (
    <div>
      <div>
        <div class="flex items-center justify-center w-[100%] h-[340px] bg-gray">
          <button class="flex flex-col items-center text-[13px] text-darkGray" onClick={addImages}>
            <svg
              width="76"
              height="68"
              viewBox="0 0 76 68"
        ...
        <button class="w-[100%] h-[44px] top-[47px] pl-[15px] absolute">
